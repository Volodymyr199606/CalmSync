  ...
  return (
    <>
      ...
      <Button
        ...
        size="icon"
        className="fixed bottom-6 right-6 z-50 h-16 w-16 rounded-full bg-primary shadow-lg hover:bg-primary/90 transition-all hover:scale-125 hover:shadow-xl animate-pulse"
